function TOPress3D_Ext_Press(nelx,nely,nelz,volfrac,penal,rmin,eta,beta,lst,maxit)
...
fixnn = intersect(BTface,Rface);
fixedUdofs = [3*fixnn-2  3*fixnn-1  3*fixnn 3*Lface-2 3*Rface-1 3*Rface-2];                             % Fixed displ.
